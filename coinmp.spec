...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727391627
...
cp %{_builddir}/CoinMP-%{version}/Cbc/LICENSE %{buildroot}/usr/share/package-licenses/coinmp/6883fd41bd845520c97b8f6146e8e05bd115bfd0 || :
cp %{_builddir}/CoinMP-%{version}/Cgl/LICENSE %{buildroot}/usr/share/package-licenses/coinmp/6883fd41bd845520c97b8f6146e8e05bd115bfd0 || :
cp %{_builddir}/CoinMP-%{version}/Clp/LICENSE %{buildroot}/usr/share/package-licenses/coinmp/6883fd41bd845520c97b8f6146e8e05bd115bfd0 || :
cp %{_builddir}/CoinMP-%{version}/CoinMP/LICENSE %{buildroot}/usr/share/package-licenses/coinmp/36830cfb4da96520f326b26f69a9f2dc5f81f971 || :
cp %{_builddir}/CoinMP-%{version}/CoinUtils/LICENSE %{buildroot}/usr/share/package-licenses/coinmp/6883fd41bd845520c97b8f6146e8e05bd115bfd0 || :
cp %{_builddir}/CoinMP-%{version}/Osi/LICENSE %{buildroot}/usr/share/package-licenses/coinmp/6883fd41bd845520c97b8f6146e8e05bd115bfd0 || :
export GOAMD64=v2
GOAMD64=v2
%make_install
