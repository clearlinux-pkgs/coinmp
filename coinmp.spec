...
Requires: coinmp-bin
Requires: coinmp-lib
Requires: coinmp-data
Requires: coinmp-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1533766119
...
export SOURCE_DATE_EPOCH=1533766119
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/coinmp
cp Cbc/LICENSE %{buildroot}/usr/share/doc/coinmp/Cbc_LICENSE
cp Cgl/LICENSE %{buildroot}/usr/share/doc/coinmp/Cgl_LICENSE
cp Clp/LICENSE %{buildroot}/usr/share/doc/coinmp/Clp_LICENSE
cp CoinMP/LICENSE %{buildroot}/usr/share/doc/coinmp/CoinMP_LICENSE
cp CoinUtils/LICENSE %{buildroot}/usr/share/doc/coinmp/CoinUtils_LICENSE
cp Osi/LICENSE %{buildroot}/usr/share/doc/coinmp/Osi_LICENSE
%make_install

%files
%defattr(-,root,root,-)
/builddir/build/BUILDROOT/coinmp-1.8.3-1.x86_64/usr/share/coin/doc/CoinMP/Makefile
/builddir/build/BUILDROOT/coinmp-1.8.3-1.x86_64/usr/share/coin/doc/CoinMP/example.c
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/coinmp/Cbc_LICENSE
/usr/share/doc/coinmp/Cgl_LICENSE
/usr/share/doc/coinmp/Clp_LICENSE
/usr/share/doc/coinmp/CoinMP_LICENSE
/usr/share/doc/coinmp/CoinUtils_LICENSE
/usr/share/doc/coinmp/Osi_LICENSE
